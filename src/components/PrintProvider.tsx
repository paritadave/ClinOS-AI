          ...
          return (
            <div
              ...
              style={{
                ...
                border: `1px solid ${isDiscontinued ? "#fecdd3" : "#e2e8f0"}`,
                borderRadius: "8px",
                padding: "12px",
                marginBottom: "8px",
              }}
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span
                  style={{
                    ...
                    padding: "2px 8px",
                    borderRadius: "4px",
                    backgroundColor: isDiscontinued ? "#f1f5f9" : "#e0e7ff",
                    color: isDiscontinued ? "#9f1239" : "#3730a3",
                  }}
                >
                  {med.status}
                </span>
              </div>
              <div style={{ color: "#475569", fontSize: "12px", marginTop: "6px", lineHeight: 1.5 }}>
                <div>
                ...
                >
                  <strong>Dosing Directions:</strong> {details.instructions}
                </div>
              </div>
            </div>
          );
